...
public class FundRequestHistoryAdapter extends BaseExpandableListAdapter {
    public Activity activity;
    private SparseArray<GroupReport> groups;
    public LayoutInflater inflater;

    public FundRequestHistoryAdapter(Activity act, SparseArray<GroupReport> groups) {
        this.activity = act;
        this.groups = groups;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = this.inflater.inflate(R.layout.fund_request_history_singleitem, parent, false);
        }
        GroupReport group = (GroupReport) getGroup(groupPosition);
        ((TextView) convertView.findViewById(R.id.f_amount)).setText(group.getAmount());
        ((TextView) convertView.findViewById(R.id.f_mode)).setText(group.getPaymentMode());
        ((TextView) convertView.findViewById(R.id.f_status)).setText(group.getStatus());
