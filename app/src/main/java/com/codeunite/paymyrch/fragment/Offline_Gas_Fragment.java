...
public class Offline_Gas_Fragment extends DialogFragment implements OnClickListener {
    ...
    /* renamed from: com.codeunite.PayMyRecharge.fragment.Offline_Gas_Fragment$1 */
    class C06311 implements OnClickListener {
        C06311() {
        }

        public void onClick(View v) {
            Offline_Gas_Fragment.this.selectOperator();
        }
    }

    /* renamed from: com.codeunite.PayMyRecharge.fragment.Offline_Gas_Fragment$2 */
    ...
    /* renamed from: com.codeunite.PayMyRecharge.fragment.Offline_Gas_Fragment$3 */
    class C06333 implements TextWatcher {
        C06333() {
        }
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            if (Offline_Gas_Fragment.this.edtAmount.getText().toString().matches("^0")) {
                Offline_Gas_Fragment.this.edtAmount.setText("");
            }
        }
    ...
    /* renamed from: com.codeunite.PayMyRecharge.fragment.Offline_Gas_Fragment$4 */
    class C06344 implements DialogInterface.OnClickListener {
        C06344() {
        }

        public void onClick(DialogInterface dialog, int id) {
            if (Offline_Gas_Fragment.this.moblayout.isErrorEnabled()) {
                Offline_Gas_Fragment.this.moblayout.setErrorEnabled(false);
            } else if (Offline_Gas_Fragment.this.amountlayout.isErrorEnabled()) {
                Offline_Gas_Fragment.this.amountlayout.setErrorEnabled(false);
            }
        }
    }

    /* renamed from: com.codeunite.PayMyRecharge.fragment.Offline_Gas_Fragment$6 */
    class C06366 implements OnItemClickListener {
        C06366() {
        }

        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            Offline_Gas_Fragment.this.OperatorName = Offline_Gas_Fragment.this.SPINNERVALUES[i];
            Offline_Gas_Fragment.this.OperatorCode = Offline_Gas_Fragment.this.SPINNERCODES[i];
            Offline_Gas_Fragment.this.operatorImageView.setImageResource(Offline_Gas_Fragment.this.gasImageId[i]);
            Offline_Gas_Fragment.this.selected_op.setText(Offline_Gas_Fragment.this.OperatorName);
            Offline_Gas_Fragment.this.tv_operator.setText(Offline_Gas_Fragment.this.OperatorName);
            Offline_Gas_Fragment.this.dialog.dismiss();
        }
    }

    /* renamed from: com.codeunite.PayMyRecharge.fragment.Offline_Gas_Fragment$7 */
    ...
    public static Offline_Gas_Fragment newInstance(String param1, String param2) {
        Offline_Gas_Fragment fragment = new Offline_Gas_Fragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_offline__gas_, null);
        ...
        this.op.setOnClickListener(new C06311());
        this.tv_operator.setOnClickListener(new C06322());
        this.opdetails = getArguments();
        this.edtAmount.addTextChangedListener(new C06333());
        this.ivPhoneBook.setOnClickListener(this);
        this.btnRecharge.setOnClickListener(this);
        builder.setTitle("Gas Bill").setView(view);
                    ...
                    if (mobNo.length() == 0) {
                        ...
                        alertDialogBuilder.setMessage("MOB NO: " + mobno + "\nOPERATOR: " + this.OperatorName + "\nAMOUNT: " + amount).setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                sendIntent.putExtra("sms_body", "PMR " + Offline_Gas_Fragment.this.OperatorCode + " " + mobno + " " + amount + " 19");
                                Offline_Gas_Fragment.this.startActivity(sendIntent);
                                Offline_Gas_Fragment.this.edtMobile.setText("");
                                if (Offline_Gas_Fragment.this.moblayout.isErrorEnabled()) {
                                    Offline_Gas_Fragment.this.moblayout.setErrorEnabled(false);
                                } else if (Offline_Gas_Fragment.this.amountlayout.isErrorEnabled()) {
                                    Offline_Gas_Fragment.this.amountlayout.setErrorEnabled(false);
                                ...
                                Offline_Gas_Fragment.this.edtAmount.setText("");
                                Offline_Gas_Fragment.this.tv_operator.setText("");
                                Offline_Gas_Fragment.this.operatorImageView.setImageResource(R.drawable.operator_status);
                                Offline_Gas_Fragment.this.edtMobile.requestFocus();
                                if (!Offline_Gas_Fragment.this.OperatorCode.equalsIgnoreCase("BT") && !Offline_Gas_Fragment.this.OperatorCode.equalsIgnoreCase("DS") && !Offline_Gas_Fragment.this.OperatorCode.equalsIgnoreCase("US") && !Offline_Gas_Fragment.this.OperatorCode.equalsIgnoreCase("BR") && !Offline_Gas_Fragment.this.OperatorCode.equalsIgnoreCase("D") && !Offline_Gas_Fragment.this.OperatorCode.equalsIgnoreCase("U")) {
                                }
                            }
                        }).setNegativeButton("No", new C06344());
    ...
    public void selectOperator() {
        ...
        this.lvSearchMobile.setOnItemClickListener(new C06366());
        right_arrow.setOnClickListener(new C06377());
        this.dialog.show();
    }
}
